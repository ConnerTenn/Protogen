...
int main()
{
	...
	SET_ADDR_MODE_CMD(1, 0);
	GRAM_WRITE(0b00111100);
	GRAM_WRITE(0b11000011);
	GRAM_WRITE(0b11000011);
	GRAM_WRITE(0b01100110);
	GRAM_WRITE(0b00000000);
	GRAM_WRITE(0b00000000);
	GRAM_WRITE(0b11111111);
	GRAM_WRITE(0b00011000);
	GRAM_WRITE(0b00011000);
	GRAM_WRITE(0b11111111);
	GRAM_WRITE(0b00000000);
	GRAM_WRITE(0b00000000);
	GRAM_WRITE(0b11111110);
	GRAM_WRITE(0b00010011);
	GRAM_WRITE(0b00010011);
	GRAM_WRITE(0b11111110);
	GRAM_WRITE(0b00000000);
	GRAM_WRITE(0b00000000);
	GRAM_WRITE(0b11111111);
	GRAM_WRITE(0b00011011);
	GRAM_WRITE(0b00111011);
	GRAM_WRITE(0b11101110);
	GRAM_WRITE(0b00000000);
	GRAM_WRITE(0b00000000);
	GRAM_WRITE(0b11111111);
	GRAM_WRITE(0b11000000);
	GRAM_WRITE(0b11000000);
	GRAM_WRITE(0b00000000);
	GRAM_WRITE(0b00000000);
	GRAM_WRITE(0b11000011);
